import { IsEmail, IsNotEmpty, IsString, MinLength, Matches, IsOptional, IsIn, IsMongoId, MaxLength } from 'class-validator';
...
export class ChangeRoleDto {
  ...
  @IsString()
  @IsNotEmpty()
  @IsIn(['ADMIN', 'INSTRUCTOR', 'USER'], { message: 'Role faqat ADMIN, INSTRUCTOR yoki USER bo\'lishi mumkin' })
  role: RoleUser;
}