import { IsEmail, IsNotEmpty, IsString, IsOptional, IsEnum, MinLength, Matches, IsMongoId } from 'class-validator';
...
export class CreateUserDto {
  ...
  @Matches(
    /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]/,
    { message: 'Parol katta harf, kichik harf, raqam va maxsus belgi (@$!%*?&) dan iborat bo\'lishi kerak' }
  )
  password: string;
